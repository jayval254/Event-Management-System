<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <li class="treeview" id="parkingSideTree">
          ...
          <ul class="treeview-menu">
            <?php if(in_array('createParking', $user_permission)): ?>
              <li id="createParkingSideTree"><a href="<?php echo base_url('parking/create') ?>"><i class="fa fa-arrow-circle-right"></i> Add Event</a></li>
            <?php endif; ?>
            <?php if(in_array('updateParking', $user_permission) || in_array('viewParking', $user_permission) || in_array('deleteParking', $user_permission)): ?>
              <li id="manageParkingSideTree"><a href="<?php echo base_url('parking') ?>"><i class="fa fa-arrow-circle-right"></i> Manage Event</a></li>
            <?php endif; ?>
          </ul>
        </li>
      <?php endif; ?>
        ...
        <li class="treeview" id="slotsSideTree">
          ...
          <ul class="treeview-menu">
            <?php if(in_array('createSlots', $user_permission)): ?>
              <li id="createSlotsSideTree"><a href="<?php echo base_url('slots/create') ?>"><i class="fa fa-arrow-circle-right"></i> Add Venue</a></li>
            <?php endif; ?>
            <?php if(in_array('updateSlots', $user_permission) || in_array('viewSlots', $user_permission) || in_array('deleteSlots', $user_permission)): ?>
            <li id="manageSlotsSideTree"><a href="<?php echo base_url('slots') ?>"><i class="fa fa-arrow-circle-right"></i> Manage Venue</a></li>
            <?php endif; ?>
          </ul>
        </li>
      <?php endif; ?>
     ...
     <!--  <?php 
      ...
      ?>
        <li id="settingSideTree"><a href="
        <?php 
        // echo base_url('users/setting/') 
        ?>">
        <i class="fa fa-cogs"></i> <span>Settings</span></a></li> 
      <?php 
    // endif; 
    ?> -->
